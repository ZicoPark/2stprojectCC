(function (o, e, t, s) {
  ...
  var r = function (t, s) {
    ...
    if (this.options.href && (
        ...
        "UL" === ("function" == typeof this.$element.prop ? 
  ...
  r.prototype = {
    ...
    show: function (t) {
      ...
      this.currentPage = t,
      this.$element.trigger("beforePage", t);
    ...
    buildListItems: function (t) {
      var s = [];
      if (this.options.first && s.push(this.buildItem("first", 1)),
      this.options.prev) {
        var e = 1 < t.currentPage ? 
                t.currentPage - 1 : 
                this.options.loop ? 
      ...
      if (this.options.next) {
        var a = t.currentPage < this.options.totalPages ? 
                t.currentPage + 1 : 
                this.options.loop ? 
                1 : 
                this.options.totalPages;
    ...
    buildItem: function (t, s) {
      var e = o("<li></li>"),
          i = o("<a></a>"),
          a = this.options[t] ? 
              this.makeText(this.options[t], s) : 
              s;

      return e.addClass(this.options[t + "Class"]),
             e.data("page", s),
             e.data("page-type", t),
    ...
    setupEvents: function () {
      ...
      this.$listContainer.off("click").on("click", "li", function (t) {
        var s = o(this);
        if (s.hasClass(e.options.disabledClass) || s.hasClass(e.options.activeClass))
          return !1;
    ...
    changeTotalPages: function (t, s) {
      return this.options.totalPages = t,
             this.show(s)
    },
    makeHref: function (t) {
    ...
    makeText: function (t, s) {
      return t.replace(this.options.pageVariable, s)
  ...
  o.fn.twbsPagination = function (t) {
    ...
    return a || i.data("twbs-pagination", a = new r(this, n)),
