...
<div class="wrapper" style="margin: 0 20px;"> 
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary card-outline" style="border-top: 3px solid #20c997!important; margin: 0 10px;">
<%--             <div class="card-header">
            ...
            <!-- /.card-header -->
              ...
              <div class="mailbox-read-info">
                  ...
                  <br/>
                  <br/>
                 <h3 style="font-weight: bold;font-size: 30px;  color: black;">&nbsp &nbsp ${detailno.subject}</h3>
                 <br/>
				<span class="mailbox-read-time float-right"> 		 
                  작성자&nbsp&nbsp  ${detailno.name}(${detailno.user_id})&nbsp&nbsp<br>
             	</span>
                  &nbsp&nbsp&nbsp&nbsp&nbsp 작성일  &nbsp ${detailno.create_at}
              ...
              <!-- /.mailbox-controls -->
				<div class="mailbox-read-message" style="height: 300px; margin-top: 30px; margin-left: 30px;">
...
<!--             <div class="card-footer bg-white">
			...
			<div class="card card-primary card-outline" style="border-top: 3px solid #20c997!important; margin: 0 10px;">
              ...
              <div class="mailbox-read-info">
                  ...
                  <br/>
                  <br/>
                 <h3 style="font-weight: bold;font-size: 30px;  color: black;">&nbsp &nbsp 공지 확인 사원 </h3>
                 <br/>
                 <br/>
                  </div>
