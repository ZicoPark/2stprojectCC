			...
			<section class="content">
				...
				<div class="row">
					<div class="col-12">
						...
						<button type="button" onclick="withDraw()" class="btn btn-secondary float-right" style="margin-left: 5px;">
							<i class="fas fa-inbox">
							문서회수
							</i>
						</button>
						<button type="button" onclick="location.href='/requestDocList.go'" class="btn btn-secondary float-right">
